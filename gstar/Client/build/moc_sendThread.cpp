...
QT_MOC_LITERAL(1, 11, 7), // "allowed"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10), // "registered"
QT_MOC_LITERAL(4, 31, 16), // "command_finished"
QT_MOC_LITERAL(5, 48, 25) // "newdocker_finished_thread"

    },
    "SendThread\0allowed\0\0registered\0"
    "command_finished\0newdocker_finished_thread"
};
...
void SendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->allowed((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4])),(*reinterpret_cast< QString(*)>(_a[5]))); break;
        case 1: _t->registered((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->command_finished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->newdocker_finished_thread(); break;
        default: ;
        }
        ...
        {
            typedef void (SendThread::*_t)(QString , QString , QString , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendThread::allowed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendThread::registered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SendThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendThread::command_finished)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SendThread::allowed(QString _t1, QString _t2, QString _t3, QString _t4, QString _t5)
{
...
// SIGNAL 1
void SendThread::registered(QString _t1)
{
...
// SIGNAL 2
void SendThread::command_finished(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
